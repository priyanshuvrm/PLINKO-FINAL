  ...
  Engine.update(engine);
   ...
   if (particle != null){
     ...
     if(particle.body.position.y > 750){
       if(particle.body.position.x < 85 && particle.body.position.x > 0 || particle.body.position.x > 720 && particle.body.position.x < 800){
         score += 500;
         particle = null;
         if(count === 5){
           gameState = 0;
      ...
      else if(particle.body.position.x > 240 && particle.body.position.x < 320 || particle.body.position.x > 480 && particle.body.position.x < 565){
        score += 200;
        particle = null;
        if(count === 5){
          gameState = 0;
